...
import { Calendar, Clock, AlertTriangle, CheckCircle, Users, FileText, Activity } from "lucide-react";
...
export function DashboardStats({ stats }: DashboardStatsProps) {
    ...
    const activeProjectRate = stats.totalProjects > 0 ? Math.round((stats.activeProjects / stats.totalProjects) * 100) : 0;
                ...
                {stats.upcomingDeadlines.length > 0 && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>7日以内に期限を迎えるプロジェクト</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-2">
                                {stats.upcomingDeadlines.slice(0, 5).map((project) => (
                                    <div key={project.projectId} className="flex items-center justify-between p-2 bg-orange-50 rounded">
                                        <div>
