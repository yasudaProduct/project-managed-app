    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          ...
          className="gap-2"
          title="タスクの絞り込み"
          data-testid="ganttv3-filter-trigger"
        >
          ...
          {activeCount > 0 && (
            <Badge
              ...
              data-testid="ganttv3-filter-count"
            >
              {activeCount}
            </Badge>
          )}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              data-testid="ganttv3-filter-clear"
            >
              <X className="h-3 w-3" />
              クリア
            </Button>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label
                htmlFor="ganttv3-filter-keyword"
            ...
            <Input
              ...
              data-testid="ganttv3-filter-keyword"
            />
            {regexInvalid && (
